...
for i in range(1,6):
    ...
    test_label_path = r"/home/chenhangting/pengshuo/CV/fold1%i_test.txt"%i
    ...
    X_train, y_train = scene_data.get_next_batch(scene_data.data_train_set, len(scene_data.data_train_set))
    Y_train = np_utils.to_categorical(y_train, nb_classes)
    
    X_test, y_test = scene_data.get_next_batch(scene_data.data_test_set, len(scene_data.data_test_set))
